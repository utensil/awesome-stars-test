...
- [mwydmuch/ViZDoom](https://github.com/mwydmuch/ViZDoom) - Doom-based AI Research Platform for Reinforcement Learning from Raw Visual Information. :godmode:
...
- [wang-bin/QtAV](https://github.com/wang-bin/QtAV) - A cross-platform multimedia framework based on Qt and FFmpeg(https://github.com/wang-bin/avbuild). High performance. User & developer friendly. Supports Android, iOS, Windows store and desktops. 基于Qt和
...
- [EnzymeAD/Enzyme](https://github.com/EnzymeAD/Enzyme) - High-performance automatic differentiation of LLVM.
...
- [lecopivo/SciLean](https://github.com/lecopivo/SciLean) - Framework for scientific computing written in Lean
...
- [AllThingsSmitty/must-watch-css](https://github.com/AllThingsSmitty/must-watch-css) - A useful list of well-received talks about CSS covering CSS Grid, flexbox, custom variables, performance, frameworks, Sass, tooling, and more.
...
- [FedML-AI/FedML](https://github.com/FedML-AI/FedML) - FedML - The federated learning and distributed training library enabling machine learning anywhere at any scale. It's backed by FedML, Inc (https://FedML.ai). Supporting large-scale geo-distributed tr
...
- [micahscopes/alglbraic](https://github.com/micahscopes/alglbraic) - a tool for generating algebraic GLSL functions
...
- [dpressel/mead-baseline](https://github.com/dpressel/mead-baseline) - Deep-Learning Model Exploration and Development for NLP
...
- [SnoopJeDi/SVGtoGeoJSON](https://github.com/SnoopJeDi/SVGtoGeoJSON) - Script for converting SVG files to GeoJSON
...
- [fredrik-johansson/mpmath](https://github.com/fredrik-johansson/mpmath) - Python library for arbitrary-precision floating-point arithmetic
...
- [icebreaker/rbGLox](https://github.com/icebreaker/rbGLox) - ruby-opengl and ruby-glfw wrapper suitable for rapid prototyping
...
- [lst-codes/rs-natural](https://github.com/lst-codes/rs-natural) - Natural Language Processing for Rust
...
- [coq-community/vscoq](https://github.com/coq-community/vscoq) - A Visual Studio Code extension for Coq [maintainers=@maximedenes,@fakusb]
...
- [boxslider/slider](https://github.com/boxslider/slider) - A modern, light weight content slider
